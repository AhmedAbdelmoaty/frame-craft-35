...
* medium; keep longer than Another Project1 because its prompts are directly reusable as patterns
...
* `Another Project4` for broad game-dev skill ecosystem
* `Another Project1` for asset cleanup and failure examples
* `Another Project2` for reusable prompt flow
* `Another Project3` for isometric workflow and fal.ai Codex skill

Most important prompts:

* `Another Project2/prompts`
* `Another Project1/prompts`
* `Another Project3/prompts`
* `Another Project4/projects/oakwoods/prompts`

Most important asset workflow:

* `Another Project1` and `Another Project2`

Most important skill source:

* `Another Project3/.codex/skills/fal-ai-image`
* `Another Project4/.agents/skills`

## Current Action

No files should be moved, deleted, or archived yet.
